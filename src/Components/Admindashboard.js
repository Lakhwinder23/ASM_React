          ...
          <div className="card dashboard-card-one pd-b-20">
            <div className="card-body">
              ...
              <div className="earning-report">
                ...
                <div className="dropdown">
                  <a className="date-dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">Jan 20, 2019</a>
                  <div className="dropdown-menu dropdown-menu-right">
              ...
              <div className="earning-chart-wrap">
                <canvas id="earning-line-chart" width={660} height={320} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card dashboard-card-two pd-b-20">
            <div className="card-body">
              ...
              <div className="expense-chart-wrap">
                <canvas id="expense-bar-chart" width={100} height={300} />
              </div>
            </div>
          </div>
        </div>
