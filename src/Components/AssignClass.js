...
import { assignClass } from '../Redux/AssignClass/AssignClassActions';
...
function AssignClass(){
  ...
  const assign_class_data = useSelector(state =>state.AssignClass)
  ...
  useMemo(()=>{
    if(assign_class_data && assign_class_data.assign_class && assign_class_data.assign_class.error){
      setError(assign_class_data.assign_class.error)
    }

  },[assign_class_data.assign_class])

  useMemo(()=>{
    if(assign_class_data && assign_class_data.assign_class && assign_class_data.assign_class.success){
      setSuccessStatus(assign_class_data.assign_class.success)
    }
  ...
  const classHandler = (event) =>{
    ...
    const asign_class_info = inputValues;
      dispatch(assignClass(asign_class_info))
  }
       ...
       <Sidebar />
        ...
        <div className="dashboard-content-one">
          ...
          <div className="card height-auto">
            {assign_class_data && assign_class_data.assign_class_loading === false ? successStatus === false || successStatus === null  ? (
              <div className="card-body">
                    ...
                    <form className="new-added-form" onSubmit={(e) =>assignClassHandler(e)}>
                      ...
                      <h2>Thank You!</h2>
                      <h2>Class Assign Successfully!</h2>
                      </div>
