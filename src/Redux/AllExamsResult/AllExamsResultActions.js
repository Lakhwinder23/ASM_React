...
export const fetchAllExamsResult = (exams_result_info) =>{
    return(dispatch) => {
      ...
      const classid = exams_result_info != undefined ? exams_result_info.classId !="" ? exams_result_info.classId : undefined : undefined
      const sectionid = exams_result_info != undefined ? exams_result_info.sectionId != ""  ? exams_result_info.sectionId : undefined:undefined
      const examid = exams_result_info != undefined ? exams_result_info.examId != "" ? exams_result_info.examId : undefined:undefined
      const year = exams_result_info != undefined ? exams_result_info.year != "" ? exams_result_info.year : undefined:undefined
